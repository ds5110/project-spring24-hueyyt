...
df_se_top = df_se[['SE_normed', 'loc', 'id']].sort_values(by='SE_normed', ascending = False, inplace=False)
df_vet_res_top = df_se[['vet', 'SE_normed', 'loc', 'id']].sort_values(by='vet', ascending = False, inplace=False)
df_incar_res_top = df_se[['estimated_incar', 'SE_normed', 'loc', 'id']].sort_values(by='estimated_incar', ascending = False, inplace=False)
df_over60_res_top = df_se[['over60', 'SE_normed', 'loc', 'id']].sort_values(by='over60', ascending = False, inplace=False)
df_dis_res_top = df_se[['dis', 'SE_normed', 'loc', 'id']].sort_values(by='dis', ascending = False, inplace=False)
df_minority_res_top = df_se[['minority_pop', 'SE_normed', 'loc', 'id']].sort_values(by='minority_pop', ascending = False, inplace=False)
df_rural_res_top = df_se[['est_rural_pop_22_v2', 'SE_normed', 'loc', 'id']].sort_values(by='est_rural_pop_22_v2', ascending = False, inplace=False)
df_lang_res_top = df_se[['estimated_lang', 'SE_normed', 'loc', 'id']].sort_values(by='estimated_lang', ascending = False, inplace=False)
df_poverty_res_top = df_se[['poverty_pop', 'SE_normed', 'loc', 'id']].sort_values(by='poverty_pop', ascending = False, inplace=False)
